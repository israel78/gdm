...
var telco_actuaciones = {
	...
	init_autoFilter: function(o_datatable) {
	    ...
	    */		
		...
		o_autoFilter[4].filter_type = "range_number"; //prioridad
		o_autoFilter[6].filter_type = "select"; //estado_ot
		o_autoFilter[7].filter_type = "select"; //nivel_autonomia
		o_autoFilter[11].filter_type = "select"; //provincia
		o_autoFilter[13].filter_type = "auto_complete"; //unidad_funcional
	...
	datatable_setConfig: function(o_html_table, json_datos) {
		...
		this.o_datatable = o_html_table.DataTable({
	        ...
	        columns: [
				...
				,{title: "Cód_OT", data: "cod_ot", render: this.col_render_WO} //5 //código ot: wo180075578826
