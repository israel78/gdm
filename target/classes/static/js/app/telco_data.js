/*
 * "telco_data", fichero.js de apoyo al jsp "telco_data,jsp"
 * 
...
/**
* objeto "telco_data", con funciones de apoyo al jsp
*/
var telco_data = {
	property_1: "",
	function_1: function() {
	...
	// properties/vars **************************************************************************
	// ******************************************************************************************
	s_contextPath: "", //telco_data.s_contextPath ="${pageContext.request.contextPath}" en .jsp  
	...
	//init_lib: function() {
	idVista: 0,
	// 1) Inicializamos la dataTable: telco_data.init_datatable($("#id_table_planes"));
	...
	datatable_setConfig: function(o_html_table, json_datos) {
		...
		this.o_datatable = o_html_table.DataTable({
	        ...
	        columns: [
	  			{title: "Cód_WK", data: "cod_wk", render: telco_data.col_render_WK} //cód. wk: wk180048465476
                                                //render: $.fn.dataTable.render.number( ',', '.', 2, '$' )
				,{title: "Estado WK", data: "estado_wk"} //estado trabajo: pendiente
				,{title: "F.creacion", data: "f_creacion"} //,{title: "F.creacion", data: "f_creacion", orderSequence: ["desc", "asc",  null]}
				,{title: "F.fin", data: "f_fin"}
				,{title: "Prioridad", data: "prioridad"} //prioridad: 4
				,{title: "Cód_OT", data: "cod_ot", render: telco_data.col_render_WO} //código ot: wo180075578826
				,{title: "Estado OT", data: "estado_ot"} //estado ot: pendiente
			...
			columnDefs: [ 
			    {	targets: 0, //col_index=0
					...
					createdCell: function (td, cellData, rowData, row, col) {
			        	...
			        	telco_data.datatable_createdCell(td, cellData, rowData, row, col);
					}
				},
			...
			*/
			//ajax: "telco-actuaciones_ajax-data.action",
			ajax: {
				type: "POST", 
				url: "telco_ajax_data.action",
				//data: ...filtrosProv..., //URL: https://datatables.net/reference/option/ajax.data
				data:  function (params) {
					params.idVista = telco_data.idVista;
		...
		setInterval( function () {
			telco_data.o_datatable.ajax.reload();
	...
	datatable_createdCell: function (td, cellData, rowData, row, col) {
		...
		*/
		/*
		//$(telco_data.o_datatable.column(0).nodes()).addClass("gri_column"); //URL: https://datatables.net/examples/api/highlight.html
		$(telco_data.o_datatable.column(col).nodes()).addClass("gri_column"); //URL: https://datatables.net/examples/api/highlight.html
		*/
	},
	//datatable_createdCell: function (td, cellData, rowData, row, col) {
	//
