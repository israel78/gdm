/*
 * "telco_actuaciones_notif.js", fichero.js de apoyo al jsp "telco_actuaciones_notif.jsp"
 * 
...
$(function () {
	...
	//telco_actuaciones_notif.init_lib();
}); //$(function () {
//------------------------------------------------------------------------------------------
...
//******************************************************************************************
//telco_actuaciones_notif object **************************************************************************
//******************************************************************************************

/**
* objeto "telco_actuaciones_notif", con funciones de apoyo al jsp
*/
var telco_actuaciones_notif = {
	property_1: "",
	function_1: function() {
		//...
	},
	...
	// properties/vars **************************************************************************
	// ******************************************************************************************
	s_contextPath: "", //telco_actuaciones_notif.s_contextPath ="${pageContext.request.contextPath}" en .jsp  
	...
	//init_lib: function() {
	idVista: 0,
	// 1) Inicializamos la dataTable: telco_actuaciones_notif.init_datatable($("#id_table_planes"));
	...
	datatable_setConfig: function(o_html_table, json_datos) {
		...
		this.o_datatable = o_html_table.DataTable({
			...
			*/
			...
			ajax_noSeUsa_sePideEn_telco_actuaciones_js: {
				type: "POST", 
				url: "telco_actuaciones.notificacion.ajax-data.action",
		...
		/* Comentado, los datos  se refrescan en "this.setJsonData" y se piden por AJAX en "telco_actuaciones.js"
	...
	datatable_createdCell: function (td, cellData, rowData, row, col) {
		...
		*/
		/*
		//$(telco_actuaciones_notif.o_datatable.column(0).nodes()).addClass("gri_column"); //URL: https://datatables.net/examples/api/highlight.html
		$(telco_actuaciones_notif.o_datatable.column(col).nodes()).addClass("gri_column"); //URL: https://datatables.net/examples/api/highlight.html
		*/
	},
	//datatable_createdCell: function (td, cellData, rowData, row, col) {
	//
	...
	ajax_error: function(xhr, error, thrown) {
        // Make your callback here.
        /*
        //alert("telco_actuaciones_notif.ajax_error(): AJAX ERROR!!!");	                
        console.log("telco_actuaciones_notif.ajax_error(): AJAX ERROR!!!");	                
        console.log(xhr);	                
        console.log(error);	                
        console.log(thrown);
        */
        console.error("telco_actuaciones_notif.ajax_error(): AJAX ERROR!!!");	                
	...
	onclick_notificacion_leido_1: function(o_datatable, row, cell, s_id_visto) {
		...
		*/
		var s_action = "telco_actuaciones.notificacion.marcar.leido.action";
		//$.post( "notificacion.marcar.leido.action", v_data)
