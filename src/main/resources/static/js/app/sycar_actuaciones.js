/*
 * "sycar_actuaciones.js", fichero.js de apoyo al jsp "sycar_actuaciones.jsp"
 * 
...
//******************************************************************************************
//sycar_actuaciones object **************************************************************************
//******************************************************************************************

/**
* objeto "sycar_actuaciones", con funciones de apoyo al jsp
*/
var sycar_actuaciones = {
	property_1: "",
	function_1: function() {
		//...
	},
	...
	// properties/vars **************************************************************************
	// ******************************************************************************************
	s_contextPath: "", //sycar_actuaciones.s_contextPath ="${pageContext.request.contextPath}" en .jsp  
	...
	//init_lib: function() {
	idFiltro: 0,
	// 1) Inicializamos la dataTable: sycar_actuaciones.init_datatable($("#id_table_planes"));
	...
	datatable_setConfig: function(o_html_table, json_datos) {
		...
		this.o_datatable = o_html_table.DataTable({
	        ...
	        columns: [
				...
				,{title: "F.modificacion", data: "f_update"} //31
			...
			*/
			...
			ajax: {
				...
				data:  function (params) {
					/* //MABarracus
					params.idFiltro = _this.idFiltro;
					*/
	...
	ajax_error: function(xhr, error, thrown) {
        // Make your callback here.
        /*
        //alert("sycar_actuaciones.ajax_error(): AJAX ERROR!!!");	                
        console.log("sycar_actuaciones.ajax_error(): AJAX ERROR!!!");	                
        console.log(xhr);	                
        console.log(error);	                
        console.log(thrown);
        */
        console.error("sycar_actuaciones.ajax_error(): AJAX ERROR!!!");	                
